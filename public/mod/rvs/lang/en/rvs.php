...
$string['tts_settings'] = 'Text-to-Speech Settings';
$string['tts_settings_desc'] = 'Configure the TTS provider used to synthesize podcast audio.';
$string['tts_provider'] = 'TTS Provider';
$string['tts_provider_desc'] = 'Service to synthesize audio (e.g., ElevenLabs).';
$string['tts_api_key'] = 'TTS API Key';
$string['tts_api_key_desc'] = 'API key for the selected TTS provider.';
$string['tts_endpoint'] = 'TTS API Endpoint';
$string['tts_endpoint_desc'] = 'Base URL for the TTS provider API.';
$string['tts_voice_id'] = 'Voice ID';
$string['tts_voice_id_desc'] = 'Voice identifier to use when generating audio.';
$string['tts_format'] = 'Audio format';
...
$string['missingamdmodule'] = 'The JavaScript module "{$a}" could not be loaded. Run "grunt amd" inside mod/rvs to rebuild assets.';
